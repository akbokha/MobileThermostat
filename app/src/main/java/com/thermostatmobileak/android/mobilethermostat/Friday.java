...
public class Friday extends Fragment {
    ...
    /* Arraylist for the switches for Friday and The initializations of the textviews for the
       switches in the layout for the friday switches */
    public ArrayList<Switch> fri_switches;
    TextView fri_switch1, fri_switch2, fri_switch3, fri_switch4, fri_switch5;

    // Textviews for displaying the day and night temperature in the weekday fragment
    TextView fri_dayTemp, fridayNightTemp;
    ...
    Button fri_add, fri_removeAll, fri_changeDayNight;

    // Array for the imagebuttons (trashcans) to delete individual switches (contrary to removeAll)
    ImageButton[] fri_independentSwitches = new ImageButton[5];
    ...
    ImageButton fri_day_edit, fri_night_edit;

    // Textviews to display day and night time when adding switches
    TextView fri_day_time, fri_night_time;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dayswitch_time = (TextView) view.findViewById(R.id.fri_day_time);
        nightswitch_time = (TextView) view.findViewById(R.id.fri_night_time);
        ...
        fri_switch1 = (TextView)view.findViewById(R.id.fri_switch1);
        fri_switch2 = (TextView)view.findViewById(R.id.fri_switch2);
        fri_switch3 = (TextView)view.findViewById(R.id.fri_switch3);
        fri_switch4 = (TextView)view.findViewById(R.id.fri_switch4);
        fri_switch5 = (TextView)view.findViewById(R.id.fri_switch5);
        fri_independentSwitches[0] = (ImageButton)view.findViewById(R.id.fri_trash1);
        fri_independentSwitches[1] = (ImageButton)view.findViewById(R.id.fri_trash2);
        fri_independentSwitches[2] = (ImageButton)view.findViewById(R.id.fri_trash3);
        fri_independentSwitches[3] = (ImageButton)view.findViewById(R.id.fri_trash4);
        fri_independentSwitches[4] = (ImageButton)view.findViewById(R.id.fri_trash5);

        fri_day_edit = (ImageButton) view.findViewById(R.id.fri_day_edit);
        fri_day_time = (TextView) view.findViewById(R.id.fri_day_time);
        fri_night_edit = (ImageButton) view.findViewById(R.id.fri_night_edit);
        fri_night_time = (TextView) view.findViewById(R.id.fri_night_time);

        fri_dayTemp = (TextView)view.findViewById(R.id.fri_day_temp);
        fridayNightTemp = (TextView)view.findViewById(R.id.fri_night_temp);

        fri_add = (Button) view.findViewById(R.id.fri_add);
        fri_removeAll = (Button)view.findViewById(R.id.fri_remove_all);
        fri_changeDayNight = (Button) view.findViewById(R.id.fri_change_button);
                ...
                try { // Get the day and night temperature to display in the fragment
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {  // setting the day and nigh temperature in the fragment
                            fri_dayTemp.setText(dayTemp + " \u2103");
                            fridayNightTemp.setText(nightTemp +  " \u2103");
                        }
                    });
                    weekProgram = HeatingSystem.getWeekProgram();
                    fri_switches = weekProgram.getDay("Friday");
                } catch (Exception e) {
         ...
         */
        fri_changeDayNight.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        fri_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Check whether the inputted times (Friday_DialogFragment_TimePick) are acceptable in
                ...
                for(int i = 0; i<5; i++) {
                    if(weekProgram.data.get(day).get(2*i).getState()) {
                        ...
                        // Check wheter there is overlap in th input (Friday_DialogFragment_TimePick)
                        if (input_day < day_old && input_night < day_old) {
                            ...
                            // not before or after: fris overlap with switch -> toastmessage
                            grant = false;
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
         ...
         */
        fri_removeAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
         ...
         */
        for(int i = 0; i < 5; i++){
            fri_independentSwitches[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // check which imagenbutton it was
                    ImageButton clickedButton = (ImageButton) v;
                    switch (clickedButton.getId()) {
                        case R.id.fri_trash1: // trash imagebutton for first switch
                            j = 0;
                            break;
                        case R.id.fri_trash2: // trash  imagebutton for second switch
                            j = 1;
                            break;
                        case R.id.fri_trash3:  // trash imagebutton for third switch
                            j = 2;
                            break;
                        case R.id.fri_trash4: // trash imagebutton for fourth switch
                            j = 3;
                            break;
                        case R.id.fri_trash5: // trash imagebutton for fifth switch
                            j=4;
                            break;
                    }
                    delete_1 = 2*j;
                    ...
                    try {
                        fri_independentSwitches[j].setVisibility(View.INVISIBLE);
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                show_max5_switches(); // see org.thermostatapp.util for the method
        ...
        */
        fri_day_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Friday_DialogFragment_TimePick();
        ...
        /* Listener for the editing the time of the day switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        fri_day_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Friday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the time textview)
          ...
          to set the time (hours : minutes)
        */
        fri_night_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Friday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        fri_night_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Friday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
    ...
    void show_max5_switches(){ // first switch
        if (fri_switches.get(0).getState()) {
            String day_hours_minutes = fri_switches.get(0).getTime();
            ...
            String night_hours_minutes = fri_switches.get(1).getTime();
            ...
            fri_switch1.setText("1. " + fri_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + fri_switches.get(1).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            fri_independentSwitches[0].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            fri_switch1.setText("");
            fri_independentSwitches[0].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (fri_switches.get(2).getState()) { // second switch
            String day_hours_minutes = fri_switches.get(2).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = fri_switches.get(3).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            fri_switch2.setText("2. " + fri_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + fri_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            fri_independentSwitches[1].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            fri_switch2.setText("");
            fri_independentSwitches[1].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (fri_switches.get(4).getState()) { // third switch
            String day_hours_minutes = fri_switches.get(4).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = fri_switches.get(5).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            fri_switch3.setText("3. " + fri_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + fri_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            fri_independentSwitches[2].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            fri_switch3.setText("");
            fri_independentSwitches[2].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (fri_switches.get(6).getState()) { // fourt switch
            String day_hours_minutes = fri_switches.get(6).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = fri_switches.get(7).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            fri_switch4.setText("4. " + fri_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + fri_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            fri_independentSwitches[3].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            fri_switch4.setText("");
            fri_independentSwitches[3].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (fri_switches.get(8).getState()) { // fifth switch
            String day_hours_minutes = fri_switches.get(8).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = fri_switches.get(9).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            fri_switch5.setText("5. " + fri_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + fri_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            fri_independentSwitches[4].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            fri_switch5.setText("");
            fri_independentSwitches[4].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
    }
