...
public class Thursday extends Fragment {
    ...
    void show_max5_switches(){ // first switch
        if (thu_switches.get(0).getState()) {
            ...
            thu_switch1.setText("1. " + thu_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + thu_switches.get(1).getType() + ": "
        ...
        if (thu_switches.get(2).getState()) { // second switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            thu_switch2.setText("2. " + thu_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + thu_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (thu_switches.get(4).getState()) { // third switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            thu_switch3.setText("3. " + thu_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + thu_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (thu_switches.get(6).getState()) { // fourt switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            thu_switch4.setText("4. " + thu_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + thu_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (thu_switches.get(8).getState()) { // fifth switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            thu_switch5.setText("5. " + thu_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + thu_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
