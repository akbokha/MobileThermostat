...
public class Thursday extends Fragment {
    ...
    /* Arraylist for the switches for Thursday and The initializations of the textviews for the
       switches in the layout for the thursday switches */
    public ArrayList<Switch> thu_switches;
    TextView thu_switch1, thu_switch2, thu_switch3, thu_switch4, thu_switch5;

    // Textviews for displaying the day and night temperature in the weekday fragment
    TextView thu_dayTemp, thursdayNightTemp;
    ...
    Button thu_add, thu_removeAll, thu_changeDayNight;

    // Array for the imagebuttons (trashcans) to delete individual switches (contrary to removeAll)
    ImageButton[] thu_independentSwitches = new ImageButton[5];
    ...
    ImageButton thu_day_edit, thu_night_edit;

    // Textviews to display day and night time when adding switches
    TextView thu_day_time, thu_night_time;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dayswitch_time = (TextView) view.findViewById(R.id.thu_day_time);
        nightswitch_time = (TextView) view.findViewById(R.id.thu_night_time);
        ...
        thu_switch1 = (TextView)view.findViewById(R.id.thu_switch1);
        thu_switch2 = (TextView)view.findViewById(R.id.thu_switch2);
        thu_switch3 = (TextView)view.findViewById(R.id.thu_switch3);
        thu_switch4 = (TextView)view.findViewById(R.id.thu_switch4);
        thu_switch5 = (TextView)view.findViewById(R.id.thu_switch5);
        thu_independentSwitches[0] = (ImageButton)view.findViewById(R.id.thu_trash1);
        thu_independentSwitches[1] = (ImageButton)view.findViewById(R.id.thu_trash2);
        thu_independentSwitches[2] = (ImageButton)view.findViewById(R.id.thu_trash3);
        thu_independentSwitches[3] = (ImageButton)view.findViewById(R.id.thu_trash4);
        thu_independentSwitches[4] = (ImageButton)view.findViewById(R.id.thu_trash5);

        thu_day_edit = (ImageButton) view.findViewById(R.id.thu_day_edit);
        thu_day_time = (TextView) view.findViewById(R.id.thu_day_time);
        thu_night_edit = (ImageButton) view.findViewById(R.id.thu_night_edit);
        thu_night_time = (TextView) view.findViewById(R.id.thu_night_time);

        thu_dayTemp = (TextView)view.findViewById(R.id.thu_day_temp);
        thursdayNightTemp = (TextView)view.findViewById(R.id.thu_night_temp);

        thu_add = (Button) view.findViewById(R.id.thu_add);
        thu_removeAll = (Button)view.findViewById(R.id.thu_remove_all);
        thu_changeDayNight = (Button) view.findViewById(R.id.thu_change_button);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try { // Get the day and night temperature to display in the fragment
                    ...
                    thu_switches = weekProgram.getDay("Thursday");
                } catch (Exception e) {
         ...
         */
        thu_changeDayNight.setOnClickListener(new View.OnClickListener() {
            @Override
         ...
         */
        thu_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                // Check whether the inputted times (Thursday_DialogFragment_TimePick) are acceptable in
                ...
                for(int i = 0; i<5; i++) {
                    if(weekProgram.data.get(day).get(2*i).getState()) {
                        ...
                        // Check wheter there is overlap in th input (Thursday_DialogFragment_TimePick)
         ...
         */
        thu_removeAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
         ...
         */
        for(int i = 0; i < 5; i++){
            thu_independentSwitches[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // check which imagenbutton it was
                    ImageButton clickedButton = (ImageButton) v;
                    switch (clickedButton.getId()) {
                        case R.id.thu_trash1: // trash imagebutton for first switch
                            j = 0;
                            break;
                        case R.id.thu_trash2: // trash  imagebutton for second switch
                            j = 1;
                            break;
                        case R.id.thu_trash3:  // trash imagebutton for third switch
                            j = 2;
                            break;
                        case R.id.thu_trash4: // trash imagebutton for fourth switch
                            j = 3;
                            break;
                        case R.id.thu_trash5: // trash imagebutton for fifth switch
                            j=4;
                            break;
                    }
                    delete_1 = 2*j;
                    ...
                    try {
                        thu_independentSwitches[j].setVisibility(View.INVISIBLE);
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                show_max5_switches(); // see org.thermostatapp.util for the method
        ...
        */
        thu_day_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Thursday_DialogFragment_TimePick();
        ...
        /* Listener for the editing the time of the day switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        thu_day_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Thursday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the time textview)
          ...
          to set the time (hours : minutes)
        */
        thu_night_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Thursday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        thu_night_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Thursday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
    ...
    void show_max5_switches(){ // first switch
        if (thu_switches.get(0).getState()) {
            String day_hours_minutes = thu_switches.get(0).getTime();
            ...
            String night_hours_minutes = thu_switches.get(1).getTime();
            ...
            thu_switch1.setText("1. " + thu_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + thu_switches.get(1).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            thu_independentSwitches[0].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            thu_switch1.setText("");
            thu_independentSwitches[0].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (thu_switches.get(2).getState()) { // second switch
            String day_hours_minutes = thu_switches.get(2).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = thu_switches.get(3).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            thu_switch2.setText("2. " + thu_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + thu_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            thu_independentSwitches[1].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            thu_switch2.setText("");
            thu_independentSwitches[1].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (thu_switches.get(4).getState()) { // third switch
            String day_hours_minutes = thu_switches.get(4).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = thu_switches.get(5).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            thu_switch3.setText("3. " + thu_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + thu_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            thu_independentSwitches[2].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            thu_switch3.setText("");
            thu_independentSwitches[2].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (thu_switches.get(6).getState()) { // fourt switch
            String day_hours_minutes = thu_switches.get(6).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = thu_switches.get(7).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            thu_switch4.setText("4. " + thu_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + thu_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            thu_independentSwitches[3].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            thu_switch4.setText("");
            thu_independentSwitches[3].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (thu_switches.get(8).getState()) { // fifth switch
            String day_hours_minutes = thu_switches.get(8).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = thu_switches.get(9).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            thu_switch5.setText("5. " + thu_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + thu_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            thu_independentSwitches[4].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            thu_switch5.setText("");
            thu_independentSwitches[4].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
    }
