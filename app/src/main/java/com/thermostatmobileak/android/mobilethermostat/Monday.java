...
public class Monday extends Fragment {
                ...
                try { // Get the day and night temperature to display in the fragment
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {  // setting the day and nigh temperature in the fragment
                            mon_dayTemp.setText(dayTemp + " \u2103"); // \u2103 is the code for the celsius degree symbol
                ...
                try {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Toast toast_changes_saved = Toast.makeText(getActivity().getApplicationContext(), "All the " + day + " switches are removed", Toast.LENGTH_SHORT);
    ...
    void show_max5_switches(){ // first switch
        if (mon_switches.get(0).getState()) {
            ...
            mon_switch1.setText("1. " + mon_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + mon_switches.get(1).getType() + ": "
        ...
        if (mon_switches.get(2).getState()) { // second switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            mon_switch2.setText("2. " + mon_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + mon_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (mon_switches.get(4).getState()) { // third switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            mon_switch3.setText("3. " + mon_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + mon_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (mon_switches.get(6).getState()) { // fourt switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            mon_switch4.setText("4. " + mon_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + mon_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (mon_switches.get(8).getState()) { // fifth switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            mon_switch5.setText("5. " + mon_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + mon_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
