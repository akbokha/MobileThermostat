...
public class Sunday extends Fragment {
    ...
    void show_max5_switches(){ // first switch
        if (sun_switches.get(0).getState()) {
            ...
            sun_switch1.setText("1. " + sun_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + sun_switches.get(1).getType() + ": "
        ...
        if (sun_switches.get(2).getState()) { // second switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            sun_switch2.setText("2. " + sun_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + sun_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (sun_switches.get(4).getState()) { // third switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            sun_switch3.setText("3. " + sun_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + sun_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (sun_switches.get(6).getState()) { // fourt switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            sun_switch4.setText("4. " + sun_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + sun_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
        ...
        if (sun_switches.get(8).getState()) { // fifth switch
            ...
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_rightFormat(intnight_hours_minutes[0], intnight_hours_minutes[1]);
            sun_switch5.setText("5. " + sun_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1] + ", " + sun_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1] + " ");
