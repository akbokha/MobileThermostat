 ...
 * {@link Sunday.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class Sunday extends Fragment {

    /* Arraylist for the switches for Sunday and The initializations of the textviews for the
       switches in the layout for the sunday switches */
    public ArrayList<Switch> sun_switches;
    TextView sun_switch1, sun_switch2, sun_switch3, sun_switch4, sun_switch5;

    // Textviews for displaying the day and night temperature in the weekday fragment
    TextView sun_dayTemp, sundayNightTemp;
    ...
    Button sun_add, sun_removeAll, sun_changeDayNight;

    // Array for the imagebuttons (trashcans) to delete individual switches (contrary to removeAll)
    ImageButton[] sun_independentSwitches = new ImageButton[5];
    ...
    ImageButton sun_day_edit, sun_night_edit;

    // Textviews to display day and night time when adding switches
    TextView sun_day_time, sun_night_time;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dayswitch_time = (TextView) view.findViewById(R.id.sun_day_time);
        nightswitch_time = (TextView) view.findViewById(R.id.sun_night_time);
        ...
        sun_switch1 = (TextView)view.findViewById(R.id.sun_switch1);
        sun_switch2 = (TextView)view.findViewById(R.id.sun_switch2);
        sun_switch3 = (TextView)view.findViewById(R.id.sun_switch3);
        sun_switch4 = (TextView)view.findViewById(R.id.sun_switch4);
        sun_switch5 = (TextView)view.findViewById(R.id.sun_switch5);
        sun_independentSwitches[0] = (ImageButton)view.findViewById(R.id.sun_trash1);
        sun_independentSwitches[1] = (ImageButton)view.findViewById(R.id.sun_trash2);
        sun_independentSwitches[2] = (ImageButton)view.findViewById(R.id.sun_trash3);
        sun_independentSwitches[3] = (ImageButton)view.findViewById(R.id.sun_trash4);
        sun_independentSwitches[4] = (ImageButton)view.findViewById(R.id.sun_trash5);

        sun_day_edit = (ImageButton) view.findViewById(R.id.sun_day_edit);
        sun_day_time = (TextView) view.findViewById(R.id.sun_day_time);
        sun_night_edit = (ImageButton) view.findViewById(R.id.sun_night_edit);
        sun_night_time = (TextView) view.findViewById(R.id.sun_night_time);

        sun_dayTemp = (TextView)view.findViewById(R.id.sun_day_temp);
        sundayNightTemp = (TextView)view.findViewById(R.id.sun_night_temp);

        sun_add = (Button) view.findViewById(R.id.sun_add);
        sun_removeAll = (Button)view.findViewById(R.id.sun_remove_all);
        sun_changeDayNight = (Button) view.findViewById(R.id.sun_change_button);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try { // Get the day and night temperature to display in the fragment
                    ...
                    sun_switches = weekProgram.getDay("Sunday");
                } catch (Exception e) {
         ...
         */
        sun_changeDayNight.setOnClickListener(new View.OnClickListener() {
            @Override
         ...
         */
        sun_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                // Check whether the inputted times (Sunday_DialogFragment_TimePick) are acceptable in
                ...
                for(int i = 0; i<5; i++) {
                    if(weekProgram.data.get(day).get(2*i).getState()) {
                        ...
                        // Check wheter there is overlap in th input (Sunday_DialogFragment_TimePick)
                        if (input_day < day_old && input_night < day_old) {
                            ...
                            // not before or after: suns overlap with switch -> toastmessage
                            grant = false;
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
         ...
         */
        sun_removeAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
         ...
         */
        for(int i = 0; i < 5; i++){
            sun_independentSwitches[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // check which imagenbutton it was
                    ImageButton clickedButton = (ImageButton) v;
                    switch (clickedButton.getId()) {
                        case R.id.sun_trash1: // trash imagebutton for first switch
                            j = 0;
                            break;
                        case R.id.sun_trash2: // trash  imagebutton for second switch
                            j = 1;
                            break;
                        case R.id.sun_trash3:  // trash imagebutton for third switch
                            j = 2;
                            break;
                        case R.id.sun_trash4: // trash imagebutton for fourth switch
                            j = 3;
                            break;
                        case R.id.sun_trash5: // trash imagebutton for fifth switch
                            j=4;
                            break;
                    }
                    delete_1 = 2*j;
                    ...
                    try {
                        sun_independentSwitches[j].setVisibility(View.INVISIBLE);
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                show_max5_switches(); // see org.thermostatapp.util for the method
        ...
        */
        sun_day_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Sunday_DialogFragment_TimePick();
        ...
        /* Listener for the editing the time of the day switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        sun_day_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Sunday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the time textview)
          ...
          to set the time (hours : minutes)
        */
        sun_night_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Sunday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        sun_night_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Sunday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
    ...
    void show_max5_switches(){ // first switch
        if (sun_switches.get(0).getState()) {
            String day_hours_minutes = sun_switches.get(0).getTime();
            ...
            String night_hours_minutes = sun_switches.get(1).getTime();
            ...
            sun_switch1.setText("1. " + sun_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + sun_switches.get(1).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            sun_independentSwitches[0].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            sun_switch1.setText("");
            sun_independentSwitches[0].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (sun_switches.get(2).getState()) { // second switch
            String day_hours_minutes = sun_switches.get(2).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = sun_switches.get(3).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            sun_switch2.setText("2. " + sun_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + sun_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            sun_independentSwitches[1].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            sun_switch2.setText("");
            sun_independentSwitches[1].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (sun_switches.get(4).getState()) { // third switch
            String day_hours_minutes = sun_switches.get(4).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = sun_switches.get(5).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            sun_switch3.setText("3. " + sun_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + sun_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            sun_independentSwitches[2].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            sun_switch3.setText("");
            sun_independentSwitches[2].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (sun_switches.get(6).getState()) { // fourt switch
            String day_hours_minutes = sun_switches.get(6).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = sun_switches.get(7).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            sun_switch4.setText("4. " + sun_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + sun_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            sun_independentSwitches[3].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            sun_switch4.setText("");
            sun_independentSwitches[3].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (sun_switches.get(8).getState()) { // fifth switch
            String day_hours_minutes = sun_switches.get(8).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = sun_switches.get(9).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            sun_switch5.setText("5. " + sun_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + sun_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            sun_independentSwitches[4].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            sun_switch5.setText("");
            sun_independentSwitches[4].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
    }
