...
public class Tuesday extends Fragment {
    ...
    /* Arraylist for the switches for Tuesday and The initializations of the textviews for the
       switches in the layout for the tuesday switches */
    public ArrayList<Switch> tue_switches;
    TextView tue_switch1, tue_switch2, tue_switch3, tue_switch4, tue_switch5;

    // Textviews for displaying the day and night temperature in the weekday fragment
    TextView tue_dayTemp, tuesdayNightTemp;
    ...
    Button tue_add, tue_removeAll, tue_changeDayNight;

    // Array for the imagebuttons (trashcans) to delete individual switches (contrary to removeAll)
    ImageButton[] tue_independentSwitches = new ImageButton[5];
    ...
    ImageButton tue_day_edit, tue_night_edit;

    // Textviews to display day and night time when adding switches
    TextView tue_day_time, tue_night_time;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dayswitch_time = (TextView) view.findViewById(R.id.tue_day_time);
        nightswitch_time = (TextView) view.findViewById(R.id.tue_night_time);
        ...
        tue_switch1 = (TextView)view.findViewById(R.id.tue_switch1);
        tue_switch2 = (TextView)view.findViewById(R.id.tue_switch2);
        tue_switch3 = (TextView)view.findViewById(R.id.tue_switch3);
        tue_switch4 = (TextView)view.findViewById(R.id.tue_switch4);
        tue_switch5 = (TextView)view.findViewById(R.id.tue_switch5);
        tue_independentSwitches[0] = (ImageButton)view.findViewById(R.id.tue_trash1);
        tue_independentSwitches[1] = (ImageButton)view.findViewById(R.id.tue_trash2);
        tue_independentSwitches[2] = (ImageButton)view.findViewById(R.id.tue_trash3);
        tue_independentSwitches[3] = (ImageButton)view.findViewById(R.id.tue_trash4);
        tue_independentSwitches[4] = (ImageButton)view.findViewById(R.id.tue_trash5);

        tue_day_edit = (ImageButton) view.findViewById(R.id.tue_day_edit);
        tue_day_time = (TextView) view.findViewById(R.id.tue_day_time);
        tue_night_edit = (ImageButton) view.findViewById(R.id.tue_night_edit);
        tue_night_time = (TextView) view.findViewById(R.id.tue_night_time);

        tue_dayTemp = (TextView)view.findViewById(R.id.tue_day_temp);
        tuesdayNightTemp = (TextView)view.findViewById(R.id.tue_night_temp);

        tue_add = (Button) view.findViewById(R.id.tue_add);
        tue_removeAll = (Button)view.findViewById(R.id.tue_remove_all);
        tue_changeDayNight = (Button) view.findViewById(R.id.tue_change_button);
                ...
                try { // Get the day and night temperature to display in the fragment
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {  // setting the day and nigh temperature in the fragment
                            tue_dayTemp.setText(dayTemp + " \u2103");
                            tuesdayNightTemp.setText(nightTemp +  " \u2103");
                        }
                    });
                    weekProgram = HeatingSystem.getWeekProgram();
                    tue_switches = weekProgram.getDay("Tuesday");
                } catch (Exception e) {
         ...
         */
        tue_changeDayNight.setOnClickListener(new View.OnClickListener() {
            @Override
         ...
         */
        tue_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                // Check whether the inputted times (Tuesday_DialogFragment_TimePick) are acceptable in
                ...
                for(int i = 0; i<5; i++) {
                    if(weekProgram.data.get(day).get(2*i).getState()) {
                        ...
                        // Check wheter there is overlap in th input (Tuesday_DialogFragment_TimePick)
         ...
         */
        tue_removeAll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
         ...
         */
        for(int i = 0; i < 5; i++){
            tue_independentSwitches[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // check which imagenbutton it was
                    ImageButton clickedButton = (ImageButton) v;
                    switch (clickedButton.getId()) {
                        case R.id.tue_trash1: // trash imagebutton for first switch
                            j = 0;
                            break;
                        case R.id.tue_trash2: // trash  imagebutton for second switch
                            j = 1;
                            break;
                        case R.id.tue_trash3:  // trash imagebutton for third switch
                            j = 2;
                            break;
                        case R.id.tue_trash4: // trash imagebutton for fourth switch
                            j = 3;
                            break;
                        case R.id.tue_trash5: // trash imagebutton for fifth switch
                            j=4;
                            break;
                    }
                    delete_1 = 2*j;
                    ...
                    try {
                        tue_independentSwitches[j].setVisibility(View.INVISIBLE);
                        getActivity().runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                show_max5_switches(); // see org.thermostatapp.util for the method
        ...
        */
        tue_day_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Tuesday_DialogFragment_TimePick();
        ...
        /* Listener for the editing the time of the day switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        tue_day_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Tuesday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the time textview)
          ...
          to set the time (hours : minutes)
        */
        tue_night_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Tuesday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
        ...
        /* Listener for the editing the time of the night switch (clicking on the edit imagebutton)
          ...
          to set the time (hours : minutes)
        */
        tue_night_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogFragment newFragment = new Tuesday_DialogFragment_TimePick();
                newFragment.show(getActivity().getFragmentManager(), "timePicker");
    ...
    void show_max5_switches(){ // first switch
        if (tue_switches.get(0).getState()) {
            String day_hours_minutes = tue_switches.get(0).getTime();
            ...
            String night_hours_minutes = tue_switches.get(1).getTime();
            ...
            tue_switch1.setText("1. " + tue_switches.get(0).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + tue_switches.get(1).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            tue_independentSwitches[0].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            tue_switch1.setText("");
            tue_independentSwitches[0].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (tue_switches.get(2).getState()) { // second switch
            String day_hours_minutes = tue_switches.get(2).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = tue_switches.get(3).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            tue_switch2.setText("2. " + tue_switches.get(2).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + tue_switches.get(3).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            tue_independentSwitches[1].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            tue_switch2.setText("");
            tue_independentSwitches[1].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (tue_switches.get(4).getState()) { // third switch
            String day_hours_minutes = tue_switches.get(4).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = tue_switches.get(5).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            tue_switch3.setText("3. " + tue_switches.get(4).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + tue_switches.get(5).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            tue_independentSwitches[2].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            tue_switch3.setText("");
            tue_independentSwitches[2].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (tue_switches.get(6).getState()) { // fourt switch
            String day_hours_minutes = tue_switches.get(6).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = tue_switches.get(7).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            tue_switch4.setText("4. " + tue_switches.get(6).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + tue_switches.get(7).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            tue_independentSwitches[3].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            tue_switch4.setText("");
            tue_independentSwitches[3].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
        if (tue_switches.get(8).getState()) { // fifth switch
            String day_hours_minutes = tue_switches.get(8).getTime();
            int[] intday_hours_minutes = to_int_conversion_24hrs(day_hours_minutes);
            String[] string_a_day_hours_minutes = int_conversion_24to12(intday_hours_minutes[0], intday_hours_minutes[1], true);
            String night_hours_minutes = tue_switches.get(9).getTime();
            int[] intnight_hours_minutes = to_int_conversion_24hrs(night_hours_minutes);
            String[] string_a_night_hours_minutes = int_conversion_24to12(intnight_hours_minutes[0], intnight_hours_minutes[1], true);
            tue_switch5.setText("5. " + tue_switches.get(8).getType() + ": " + string_a_day_hours_minutes[0]+":"+string_a_day_hours_minutes[1]+" "+string_a_day_hours_minutes[2] + ", " + tue_switches.get(9).getType() + ": "
                    + string_a_night_hours_minutes[0]+":"+string_a_night_hours_minutes[1]+" "+string_a_night_hours_minutes[2] + " ");
            tue_independentSwitches[4].setVisibility(View.VISIBLE); // it becomes visible in the layout
        } else {
            tue_switch5.setText("");
            tue_independentSwitches[4].setVisibility(View.INVISIBLE); // it becomes invisible in the layout
        }
    }
